...
// DEFAULT_CONTROL_VERBS/CONTROL_BINARIES/loadControlPolicy moved verbatim
// into scripts/orchestrator-tools/agents.ts (Fase 5 / M2) — exclusive to
// agent_control, no other call site in this file.
...
// worktree_create/worktree_list_open/finalize_evidence_collect/
	// finalize_evidence_list/worktree_finalize/worktree_abandon all wired
	// below (after requireWorktree is built) via a single
	// createWorktreeTools(...) loop (Fase 5 / M3).
