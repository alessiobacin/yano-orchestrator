...
23. [Migrazione posta schedulata a job self](./28-migrazione-posta-self.md)
24. [Bootstrap documentale del progetto](./24-bootstrap-documentale-progetto.md)
25. [Ottimizzazione di applicazioni AI](./26-ottimizzazione-app-ai.md)
26. [REST API utente in Yano](./27-api-rest-utente.md)
27. [Audit campaign: QA, architettura, prodotto e orchestrazione](../guides/playbooks/audit-campaign.usage.md)
