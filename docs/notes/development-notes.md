...
la snapshot per lo stesso pane e sopprime il falso negativo solo quando Herdr
conferma `agent: pi` in uno stato non terminale. Un'identità diversa o uno
stato offline resta un errore esplicito. La regressione end-to-end è in
