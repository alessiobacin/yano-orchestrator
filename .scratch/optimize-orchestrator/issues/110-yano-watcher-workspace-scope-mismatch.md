...
fingerprint: 01bfb031c3785d2901831774fb2e94f7613f0c37440ac880bec2e90ec8987e7a
detected_at: 2026-09-02T08:21:15.494Z
source_project: context-compaction-smoke
source_project_root: /var/folders/n1/86crx3px60355s2z86fvvxtm0000gn/T/yano-context-project-YnpUCi
source_project_key: workspace-b7f2d227bfe5
run_id: unknown
round: unknown
task: unknown
instance: planner-01
...
- Categoria: `isolation`
- Progetto osservato: `context-compaction-smoke` (/var/folders/n1/86crx3px60355s2z86fvvxtm0000gn/T/yano-context-project-YnpUCi)
- Timestamp del record: `2026-09-02T08:21:15.149Z`
- Record di trace: `unknown`

```json
{
  "ts": "2026-09-02T08:21:15.149Z",
  "seq": 4,
  "instance": "planner-01",
  "role": "planner",
  "project": "context-compaction-smoke",
  "project_key": "workspace-b7f2d227bfe5",
  "trace_mode": "events",
  "type": "presence_ignored_scope_mismatch",
  "topic": "pi/context-compaction-smoke/agents/planner-01/status",
  "card_instance": "planner-01",
  "card_project": "context-compaction-smoke",
  "card_project_key": null,
  "expected_project": "context-compaction-smoke"
}
```
