...
1. Identifica il progetto di riferimento e il suo confine: un progetto applicativo gestito da Yano, oppure Yano stesso (in tal caso rispetta lo stesso confine `yano-maintenance` del feedback — solo la root di yano-orchestrator, mai un altro progetto).
