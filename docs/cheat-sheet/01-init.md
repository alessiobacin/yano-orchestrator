...
`yano-local-pc` è installato e supervisionato globalmente; non è un'opzione
per singolo progetto. --herdr apre il workspace e il planner; --force serve solo quando il target
